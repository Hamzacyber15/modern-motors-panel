// import 'package:app/modern_motors/billing/create_bill.dart';
...
// import 'package:app/modern_motors/models/branch/branch_model.dart';
...
// import 'package:app/modern_motors/products/product_card.dart';
...
// import 'package:app/modern_motors/widgets/delete_helper.dart';
...
// //   void _openDirectInventoryAdd(ProductModel product) {
...
//   // void _showViewOptions(BuildContext context, ProductModel product) {
//   //   showDialog(
//   //     context: context,
//   //     builder: (context) => AlertDialog(
//   //       title: Text('View Options for ${product.productName}'),
//   //       content: Column(
//   //         mainAxisSize: MainAxisSize.min,
//   //         children: [
//   //           ListTile(
//   //             leading: const Icon(Icons.history),
//   //             title: const Text('View Inventory Logs'),
//   //             onTap: () {
...
//   //             title: const Text('View Inventory Batches'),
//   //             onTap: () {
//   //               Navigator.pop(context);
//   //               Navigator.of(context).push(
//   //                 MaterialPageRoute(
//   //                   builder: (context) =>
//   //                       ProductInventoryBatches(product: product),
//   //                 ),
//   //               );
//   //             },
//   //           ),
...
//                     //importButtonText: 'Import products'.tr(),
//                     selectedItems:
...
//                     //     headers: headers,
//                     //     rows: rowsToExport,
//                     //     fileNamePrefix: "PDF Inventory_Report",
//                     //   );
//                     // },
//                   ),
//                   allProducts.isEmpty
...
//                               // setState(() {
//                               //   if (isSelected == true) {
//                               //     selectedInventories.addInventory(  ,product);
//                               //   } else {
//                               //     selectedInventories.removeInventory( ,product);
//                               //   }
//                               // });
//                             },
//                             // onView: (product) {
...
//         // Low stock filter
//         if (showLowStock &&
//             (product.totalStockOnHand ?? 0) > (product.threshold ?? 0)) {
//           return false;
//         }

//         // Zero stock filter
//         if (showZeroStock && (product.totalStockOnHand ?? 0) > 0) {
//           return false;
//         }
...
//           // Second row of filters (checkboxes)
//           Wrap(
//             spacing: 24,
//             children: [
//               // Low stock filter
//               FilterChip(
//                 label: Text('Low Stock'.tr()),
...
//                     if (selected)
//                       showZeroStock =
//                           false; // Deselect zero stock if low stock is selected
//                   });
//                   _applyFilters();
//                 },
...
//               // Zero stock filter
//               FilterChip(
//                 label: Text('Out of Stock'.tr()),
//                 selected: showZeroStock,
//                 onSelected: (selected) {
//                   setState(() {
//                     showZeroStock = selected;
//                     if (selected)
//                       showLowStock =
//                           false; // Deselect low stock if zero stock is selected
//                   });
//                   _applyFilters();
//                 },
//                 checkmarkColor: Colors.white,
