...
import 'package:modern_motors_panel/modern_motors/widgets/invoices/order_summary_details.dart';
...
class CreateBill extends StatefulWidget {
  ...
  @override
  CreateBillPageState createState() => CreateBillPageState();
}

class CreateBillPageState extends State<CreateBill> {
        ...
        setState(() {
          ...
          WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
            if (widget.invoiceModel != null) {
              ...
              // debugPrint('foundDiscount: ${foundDiscount.toMap()}');
