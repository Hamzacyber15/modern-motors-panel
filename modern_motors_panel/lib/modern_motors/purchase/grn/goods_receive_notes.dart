...
import 'package:modern_motors_panel/modern_motors/purchase/grn/add_edit_goods_receive_note.dart';
...
class GoodsReceiveNotes extends StatefulWidget {
  final void Function(String page)? onNavigate;

  const GoodsReceiveNotes({super.key, this.onNavigate});

  @override
  State<GoodsReceiveNotes> createState() => _GoodsReceiveNotesState();
}

class _GoodsReceiveNotesState extends State<GoodsReceiveNotes> {
    ...
    return showInventoryList
        ? SingleChildScrollView(
            child: Column(
              children: [
                PageHeaderWidget(
                  title: 'Goods Receive Notes'.tr(),
                  buttonText: "Goods Receive Notes".tr(),
                ...
                allPurchaseOrders.isEmpty
                    ...
                    : DynamicDataTable<GrnModel>(
                        data: pagedItems,
                        columns: procurementHeaders,
                        isWithImage: true,
                        combineImageWithTextIndex: 3,
                        valueGetters: [
                          // (v) => '${v.name} , ${v.image}',
                          (v) => '${"GRN"} - ${v.grnNumber}',
                          (v) => '${"PO"} - ${v.poNumber}',
                          ...
                          (v) => vendors
                              ...
                              .vendorName,
                          (v) => v.receivedQuantity.toString(),
                          (v) => v.rejectedQuantity.toString(),
                          (v) => v.orderedQuantity.toString(),
