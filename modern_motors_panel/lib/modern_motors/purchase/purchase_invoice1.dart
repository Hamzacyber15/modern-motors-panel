...
mixin PerformanceOptimizer on State<PurchaseInvoice1> {
  final Map<String, Timer> _timers = {};
...
class PurchaseInvoice1 extends StatefulWidget {
  final VoidCallback? onBack;
  final NewPurchaseModel? purchase;
  final List<ProductModel>? products;
  final String? type;
  ...
  @override
  State<PurchaseInvoice1> createState() => _PurchaseInvoice1State();
}

class _PurchaseInvoice1State extends State<PurchaseInvoice1>
    with PerformanceOptimizer {
  final supplierNameController = TextEditingController();
  final discountController = TextEditingController();
  final depositAmountController = TextEditingController();
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    //       //   });
                    //       //   debugPrint(
                    //       //     "${"cost inclusion"}${includeExpensesInProductCost}",
                    //       //   );
                    //       // }
                    //       if (mounted) {
                    //         setState(() {
                    //           includeExpensesInProductCost = value ?? false;
                    //         });
                    //       } else {
                    //         includeExpensesInProductCost = value ?? false;
                    //       }
                    ...
                    Transform.scale(
                      ...
                      child: Checkbox(
                        ...
                        onChanged: (value) {
                          setState(() {
                            includeExpensesInProductCost =
                                value ?? false; // Use false as default
                          });
                          debugPrint(
                            "cost inclusion: $includeExpensesInProductCost",
                          );
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 100, child: _buildVatAmountDisplay()),
          const SizedBox(width: 8),
          SizedBox(width: 100, child: _buildTotalDisplay()),
          const SizedBox(width: 8),
          SizedBox(width: 100, child: _buildIncludeInProductCostCheckbox()),
          IconButton(
            icon: const Icon(Icons.remove_circle, color: Colors.red, size: 20),
            onPressed: widget.onRemove,
          ),
