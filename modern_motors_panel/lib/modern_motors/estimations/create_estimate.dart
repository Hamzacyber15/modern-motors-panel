...
class _CreateEstimateState extends State<CreateEstimate> {
  ...
  Future<void> _loadInitialData() async {
    ...
    if (widget.sale == null) {
      var value = await Constants.getUniqueNumberValue("Estimate");
      invNumber = value;
    } else {
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                //       _buildRow('Balance Due', nextPaymentAmount,
                      ...
                      final paymentData = isAlreadyPaid
                          ? {
                              ...
                              'paymentMethods': paymentRows
                                  ...
                                  .toList(),
                              'totalPaid': paymentRows.length > 1
                                  ? paymentRows.fold(
                                      0,
                                      (sum, row) => sum + row.amount as int,
                                    )
