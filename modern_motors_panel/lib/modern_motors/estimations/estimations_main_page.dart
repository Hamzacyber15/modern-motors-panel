...
class EstimationsMainPage extends StatefulWidget {
  const EstimationsMainPage({super.key});

  @override
  State<EstimationsMainPage> createState() => _EstimationsMainPageState();
}

class _EstimationsMainPageState extends State<EstimationsMainPage> {
