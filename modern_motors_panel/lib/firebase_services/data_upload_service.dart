...
class DataUploadService {
  ...
  static Future<void> processSale(Map<String, dynamic> saleData) async {
    ...
    try {
      ...
      final batchesCollection = FirebaseFirestore.instance.collection(
        'mmInventoryBatches',
      );
      ...
      for (final item in items) {
        ...
        for (final batchDoc in availableBatches.docs) {
          ...
          final quantityToTake = remainingQty > availableInBatch
              ? availableInBatch
              : remainingQty;
      ...
      final logsCollection = FirebaseFirestore.instance.collection(
        'mmInventoryLogs',
      );
  ...
  static Future<void> addPurchaseOrderFunction(PurchaseOrderModel model) async {
    final dataToSave = {
      'productId': model.productId,
      'createdBy': model.createdBy,
